...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.kcwdev.downloader.js')
	...
	f = os.path.join(cwd,'Classes','ComKcwdevDownloaderModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.kcwdev.downloader.js']
